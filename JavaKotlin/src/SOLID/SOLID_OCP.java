...
// SOLID.PaymentProcessor 에서 새 결제 유형을 추가하려면
// 기존 SOLID.PaymentProcessor 클래스를 수정해야 하므로
// 개방-폐쇄 원칙을 위반함
...
// 새 결제 유형을 추가하려면, SOLID.Payment 인터페이스를 구현하는 새 클래스를 생성하여
// SOLID.PaymentProcessor 를 수정할 때는 닫힌 상태로, 확장할 땐 열린 상태로 유지
